...
var TTFFont = module.exports = function(buffer) {
  ...
  this.metaData = {}
  this.tables.name.records.forEach(function(record) {
    console.log(record.nameID, this.metaData[0])
    this.metaData[record.nameID] = this.metaData[record.nameID] || {}
    console.log(this.metaData[record.nameID], record.languageID)
    this.metaData[record.nameID][record.languageID] = record.string
  }.bind(this))
